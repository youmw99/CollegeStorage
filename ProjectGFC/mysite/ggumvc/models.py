...
class GgumvcGguuser(models.Model):
    stunum = models.IntegerField()
    name = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'ggumvc_gguuser'


class Gguuser(models.Model):
    stunum = models.IntegerField(primary_key=True)
    name = models.CharField(max_length=32)
    passwd = models.CharField(max_length=100)
    idcardimg = models.TextField(blank=True, null=True)
...
class Temptable(models.Model):
    tempinc = models.AutoField(primary_key=True)
    tempcol = models.CharField(max_length=45, blank=True, null=True)
    tempcoll = models.CharField(max_length=45, blank=True, null=True)
    tempcolll = models.CharField(max_length=45, blank=True, null=True)
